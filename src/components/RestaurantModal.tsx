...
const RestaurantModal: React.FC<RestaurantModalProps> = ({ restaurant, isOpen, onClose, onClaimRestaurant, user }) => {
  ...
  React.useEffect(() => {
    if (isOpen && restaurant) {
      trackRestaurantView(restaurant.id);
    }
  }, [isOpen, restaurant]);
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
                ...
                {restaurant.phone && (
                  <div className="flex items-center space-x-3">
                    ...
                    <a
                      ...
                      onClick={() => trackPhoneClick(restaurant.id)}
                    >
                      {restaurant.phone}
                    </a>
                  </div>
                ...
                {restaurant.website && (
                  <div className="flex items-center space-x-3">
                    ...
                    <a
                      ...
                      onClick={() => trackWebsiteClick(restaurant.id)}
                    >
                      Visit Website
              ...
              {/* Social Media Links */}
              {(restaurant.facebook_url || restaurant.instagram_url || restaurant.twitter_url || restaurant.linkedin_url || restaurant.youtube_url) && (
                <div className="mt-6 pt-6 border-t border-gray-200">
                  ...
                  <div className="flex space-x-3">
                    ...
                    {restaurant.linkedin_url && (
                      <a
                        href={restaurant.linkedin_url}
                        target="_blank"
                        rel="noopener noreferrer"
              ...
              <div className="mt-6 space-y-3">
                ...
                <button
                  ...
                  onClick={() => {
                    trackDirectionsClick(restaurant.id);
